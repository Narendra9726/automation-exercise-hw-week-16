...
Feature: As a user,
  ...
  Scenario: User should register successfully
    ...
    And I send name "Narendra" and email "narendra123" to signup
    And I click on button "Signup"
    Then I should see text "ENTER ACCOUNT INFORMATION"
    And I fill all details in signup page "Mr" "Narendra" "26" "December" "1989" "Narendra" "Dhaduk" "White pearl" "Ahmedabad" "India" "Gujarat" "Ahmedabad" "380024" "09904687898"
    ...
    Then I should see the text "Logged in as " "Narendra"
  ...
  Scenario: User should see error message while register with existing email
    ...
    When I click on header menu option "Signup / Login"
    Then I should see the login page text "New User Signup!"
    And I send name "Narendra" to name field in signup
    And I send email "narendra123@gmail.com" to email field in signup
    And I click on button "Signup"
  ...
  Scenario: User should Place Order: Register while Checkout
    ...
    And I send name "Narendra" and email "narendra123" to signup
    And I click on button "Signup"
    And I fill all details in signup page "Mr" "narendra123@gmail.com" "26" "December" "1989" "Narendra" "Dhaduk" "White pearl" "Ahmedabad" "India" "Gujarat" "Ahmedabad" "380024" "09904687898"
    And I click on Create Account button
    Then I see account created message "ACCOUNT CREATED!"
    And I click on continue button
    Then I should see the text "Logged in as " "Narendra"
    ...
    And I enter payment details "Narendra Dhaduk" "4263982640269399" "999" "02" and "2025"
  ...
  Scenario: Verify address details in checkout page
    ...
    And I should see the welcome text on shopping cart page "Shopping Cart"
    And I click on Proceed to Checkout button
    Then I should see the delivery address is same address filled at the time registration of account "White pearl"
    And I should see billing address is same address filled at the time registration of account "White pearl"
    And I click on header menu option "Delete Account"
    Then I should see the account deleted message "ACCOUNT DELETED!"
    And I click on continue button after deleting account
